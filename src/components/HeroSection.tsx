          ...
          <div className="grid grid-cols-2 gap-4">
            <Card className="bg-white/10 backdrop-blur-sm border-white/20">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm text-blue-100">Programas de desarrollo profesional</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white/10 backdrop-blur-sm border-white/20">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm text-blue-100">Red de educadores comprometidos</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white/10 backdrop-blur-sm border-white/20">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm text-blue-100">Servicios de salud y bienestar</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white/10 backdrop-blur-sm border-white/20">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm text-blue-100">Seguridad social y legal</p>
              </CardContent>
            </Card>
          </div>
        </div>
